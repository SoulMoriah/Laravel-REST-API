...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($product_save){
            ...
            $response= APIHelpers::createAPIResponse(true, 400, 'Product creation failled', null);
    ...
    public function update(Request $request, $id)
    {
        ...
        if($product_update){
            ...
            $response= APIHelpers::createAPIResponse(true, 400, 'Product update failled', null);
            return response()->json($response, 400);
        }
    ...
    public function destroy($id)
    {
        ...
        if($product_delete){
            ...
            $response= APIHelpers::createAPIResponse(true, 400, 'Product delete failled', null);
            return response()->json($response, 400);
        }
    }
}
